    ...
    def ejecucion(self):
        ...
        while indice <= len(pila):
            ...
            if cuadruplo[0] == 0:  # GOTOMAIN
                ...
                print(memoria.obtenerValor(cuadruplo[1]))
                ...
                indice = memoria.obtenerValor(dir_indice)
                dir_base = cuadruplo[2]
                nueva_direccion = dir_base + indice
                resultado = cuadruplo[-1]
                memoria.actualizarValor(resultado, f"D{nueva_direccion}")
